...
steps_epoch = 1
size = 1
max_num_batch = math.floor(len(trainingNames)/steps_epoch)
model.fit_generator(hf.data_generator2(max_num_batch, trainingNames, y, PATH, steps_epoch), steps_per_epoch=1)
