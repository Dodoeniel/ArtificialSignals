...
def define_model(training_data):
    ...
    model.add(LSTM(lstm_size_l1, input_shape=(training_data.shape[1],training_data.shape[0])))
...
#path = '/Users/Danie/Nextcloud/Masterarbeit/Künstliche_Signale/PythonCode/TestRun1/'
path = 'TestRun1/'
fileNameNames = 'NamesTraining.csv'
fileNameLabels = 'LabelsTraining.csv'
#C:\Users\Danie\Nextcloud\Masterarbeit\Künstliche Signale\PythonCode
